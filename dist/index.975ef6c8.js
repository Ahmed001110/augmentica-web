...
async function setupViewer() {
    ...
    const viewer = new (0, _webgi.ViewerApp)({
        canvas: document.getElementById("webgi-canvas")
    });
    // Add some plugins
    const manager = await viewer.addPlugin((0, _webgi.AssetManagerPlugin));
    // Add a popup(in HTML) with download progress when any asset is downloading.
    await viewer.addPlugin((0, _webgi.AssetManagerBasicPopupPlugin));
    ...
    await (0, _webgi.addBasePlugins)(viewer);
    // Add more plugins not available in base, like CanvasSnipperPlugin which has helpers to download an image of the canvas.
    await viewer.addPlugin((0, _webgi.CanvasSnipperPlugin));
    // This must be called once after all plugins are added.
    viewer.renderer.refreshPipeline();
    // Import and add a GLB file.
    let url = new URL(require("74b790869450e236"));
    url = "" + url;
...
},{"webgi":"4UkFg","./styles.css":"lW6qc","74b790869450e236":"gNs4y"}],"lW6qc":[function() {},{}],"gNs4y":[function(require,module,exports) {
module.exports = require("896f4563e1409ca4").getBundleURL("bLxZJ") + "sofa.b5b4de03.glb" + "?" + Date.now();

},{"896f4563e1409ca4":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}]},["igKGj","8lqZg"], "8lqZg", "parcelRequirebd24")
